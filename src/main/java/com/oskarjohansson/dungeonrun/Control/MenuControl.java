...
import com.oskarjohansson.dungeonrun.Model.Character.Barbarian;
import com.oskarjohansson.dungeonrun.Model.Character.CodeMonkey;
...
@Component
public class MenuControl implements CommandLineRunner {
    ...
    @Autowired
    public MenuControl(HeroService heroService) {
    ...
    public void showStartGameTerminalDisplay(){
        System.out.printf("""
                ...
                #1 - Create a New Player    |   #2 - Load Game      |   #3 - Show all games      |
    ...
    public void mainMenu(PlayerControl player, MenuControl menuControl, MapControl mapControl, ShopControl shopControl, BossCombatControl bossCombatControl, MonsterCombatControl monsterCombatControl) {
        ...
        do {
            System.out.printf("""
                    ...
                    #1 - Show %s the %s's Level  |   #2 - Show Stats  |   #3 - Show MAP   |   #4 - Enter SHOP   |   #5 - Save Game   | #6 - Delete Game   |
    ...
    public void getPlayerStats(PlayerControl player) {
        ...
        System.out.printf("""
                ...
                Level  \033[1;33m%d\033[0m   |   Experience Points   \033[1;33m%d/%d\033[0m  |   Strength    \033[1;35m%d\033[0m  |   Intelligence   \033[1;32m%d\033[0m  |   Agility   \033[1;31m%d\033[0m  |
                                
                """, player.getHero().getLevel(), player.getHero().getExperiencePoints(), player.getHero().getLevel() * 10, player.getHero().getStrength(), player.getHero().getIntelligence(), player.getHero().getAgility());
    }
    ...
    public void savePlayer(PlayerControl player) {
        heroService.saveHero(player.getHero());

    }

    public void showAllHeros() {
        List<Hero> heroes = heroService.loadAllHero();
        if (heroes.size() == 0) {
    ...
    public void loadPlayer(PlayerControl player) {
        System.out.println("Enter ID to load player: ");
        player.setHero(heroService.loadHero((long) UserInputControl.inputInt()));
    }
    ...
    public void deletePlayer(PlayerControl player) {

        heroService.deleteHero((long) player.getHero().getId());
    }
